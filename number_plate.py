...
harcascade = r"C:\Users\Admin\Documents\Data Science Course Materials\Computer Vision Projects\Car Number Plate Detection\pre-trained model\haarcascade_russian_plate_number.xml"
# 'r' is used to resolve unicodeescape error
...
while True:
    ...
    # The parameter 1.1 refers to the scaleFactor(Good starting point). This parameter specifies how much the image size is reduced at each image scale. 
